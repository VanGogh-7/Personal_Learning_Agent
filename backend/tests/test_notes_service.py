...
def test_list_notes_returns_active_notes_by_default(notes_session) -> None:
    ...
    archived = create_note(notes_session, title="Archived", content_latex="\\section{B}")
...
def test_get_note_by_id(notes_session) -> None:
    created = create_note(notes_session, title="Fetch Me", content_latex="\\section{Fetch}")
...
def test_update_note_title_and_content(notes_session) -> None:
    created = create_note(notes_session, title="Draft", content_latex="\\section{Draft}")
...
def test_archive_note_sets_status_archived(notes_session) -> None:
    created = create_note(notes_session, title="Archive Me", content_latex="\\section{Archive}")
